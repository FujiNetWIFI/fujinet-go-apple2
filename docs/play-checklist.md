# FujiNet Go Apple2 — Google Play submission checklist
...
1. Play Console → Create app — name "FujiNet Go Apple2", App, Free.
...
- Description: reuse the repo README / zapstore.yaml copy. Must include:
  - a link to https://github.com/FujiNetWIFI/fujinet-go-apple2 (GPL source offer), and
  - ROM wording: "Apple II system ROMs are NOT included; users import their own on first run."
...
- Privacy policy URL: https://fujinetwifi.github.io/fujinet-go-apple2/
...
- **Foreground service — FGS_SPECIAL_USE declaration**. Justification (matches
  ...
  "Runs the Apple II emulator and the FujiNet network bridge while the
